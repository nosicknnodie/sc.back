...
export const env = {
    ...
    app: {
        ...
        url: {
            api: getOsEnv('APP_SCHEMA') + '://' + getOsEnv('APP_HOST')
                + (normalizePort(process.env.PORT || getOsEnv('APP_PORT')) === 80 ? '' : ':' + normalizePort(process.env.PORT || getOsEnv('APP_PORT')))
    ...
    db: {
        ...
        charset: getOsEnvOptional('TYPEORM_CHARSET'),
    },
    graphql: {
